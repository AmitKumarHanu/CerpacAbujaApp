<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="frmGenrateEncryptfileAfterQC.aspx.cs" Inherits="Admin_frmGenrateEncryptfileAfterQC" %>
...
<script type="text/javascript">
    ...
    function CallConfirmBox() {
     ...
     if (confirm("Request file successfull created on desktop :" + confirm_value + "")) {
         ...
         window.location.href = "frmGenrateEncryptfileAfterQC.aspx";
 ...
 <table  id="combox" style="width:720px;" >
            
 <tr>                
                <td colspan="3" style="height: 5px">
                    <div class="PageNameHeadingCSS" style="text-align: center">
                         <font class="b12"><span style="font-size: 16px; color:White;">&nbsp; Encrypt File After Quality for Zone </span>
                        </font>
                    </div>
                </td>
            </tr>
