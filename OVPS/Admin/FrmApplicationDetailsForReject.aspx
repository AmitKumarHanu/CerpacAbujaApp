<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="FrmApplicationDetailsForReject.aspx.cs" Inherits="Admin_FrmApplicationDetailsForReject" EnableEventValidation="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <script type="text/javascript">
      function buttonchange() {
          ...
          var compname = (document.getElementById('<%=txtcompid.ClientID%>'))
          if (compname.value.length == 0) {
              blnFalg = false;
              msg += "Company Id  \n";
          }
...
<tr class="b55"><td  class="b55" align="left" >Middle Name</td><td id="bnkmname" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtMiddleName" runat="server" CssClass="textbox2"  Enabled="false"></asp:TextBox>
                                </td>
...
<tr class="b55"><td  class="b55" align="left" >Nationality</td><td id="bnknationality" runat="server">
                                    ...
                                    <asp:DropDownList ID="TxtNationality" runat="server" CssClass="textbox2" AutoComplete="Off" Height="20px" Width="130px"></asp:DropDownList>
                                 <span class="star">*                           
                            </span>
                                </td></tr>
                        ...
                        <table cellpadding="5" cellspacing="2" border="0" width="745px" id="detailtable" runat="server">
                            ...
                            <tr class="t11">
                                <td colspan="2" align="center" style="height: 2px;">
                                   <asp:HiddenField ID="hidcerpac" runat="server" /></td><td colspan="2">
                                    <asp:HiddenField ID="hidreceiptdate" runat="server" />
                                </td>
                            </tr>
                            ...
                            <tr  class="b55" >
                                ...
                                <span class="star">*                           
                                     ...
                                     <a id="A2" runat="server" href="javascript:NewCal('','DDMMMYYYY')">
                                <img alt="Pick a date" src="../Images/cal.jpg" style="border: 0" /></a>
                                </td>
                            </tr>
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="txtcompid" runat="server" CssClass="textbox2" AutoComplete="Off"></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                     </td>
                                <td align="left" style="width: 150px;">
            ...
            <tr class="b11">
                ...
                <td align="left"><asp:Label ID="lbldeprel" runat="server" Text="Dependence Relation" Visible="false"></asp:Label></td><td align="left"><asp:DropDownList ID="drprltn" runat="server" CssClass="textbox2" Visible="false"></asp:DropDownList></td>
                ...
                <td colspan="4" align="left" style="height: 20px;">
                    &nbsp;</td></tr>
                               <tr>
                <td colspan="1" align="left" style="height: 20px;" class="b77"><strong> Previous Notes </strong>
                    
                </td>
    <td align="left" colspan="3"><asp:TextBox ID="txtprevnotes" Style="resize:none;" runat ="server" ReadOnly="true" Height="44px" AutoComplete="Off" Width="550px"></asp:TextBox></td>
            </tr>
                            <tr class="b11">
                <td colspan="4" align="left" style="height: 20px;">
                </td>
