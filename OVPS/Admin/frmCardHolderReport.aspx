<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="frmCardHolderReport.aspx.cs" Inherits="Admin_frmCardHolderReport" %>
            ...
            <tr>
                ...
                <td colspan="6" style="height: 5px">
                    <div class="PageNameHeadingCSS" style="text-align: center">
                         <font class="b12"><span style="font-size: 16px; color:White;">Card Holder's Report &nbsp; </span>
                        </font>
                    </div>
                </td>
            </tr>
        ...
        <img alt="Pick a date" src="../Images/cal.jpg" style="border: 0" /></a> </span>
          ...
          <td style="width: 30px">&nbsp;</td>
            <td colspan="5" align="center"> 
                ...
                <asp:ImageButton ID="ImageButton1" runat="server"  ImageUrl="~/Images/print.png" CssClass="Adminshortcut" Height="25px" Width="25px"     OnClientClick="PrintContent()" />
                 ...
                 <tr style="display:none;">
                    ...
                    <td colspan="4">
                        ...
                        <asp:DropDownList ID="dpd_zone" runat="server" CssClass="textbox2" Width="10px" OnSelectedIndexChanged="dpd_zone_SelectedIndexChanged" AutoPostBack="true">
                ...
                <asp:DropDownList ID="dpd_search" runat="server" CssClass="textbox2" Width="10px" 
                    >
            ...
            <span id="sp2" runat="server">
                ...
                <a title="abcde" id="comptool" onmouseover="return compnyname();">
                                    <asp:TextBox ID="txtcompname" runat="server" CssClass="textbox2" Width="30px" Enabled="true" AutoComplete="Off" Text="ALL"></asp:TextBox>
                                       </a> 
                                 <span class="star">       
                ...
                <span id="sp3" runat="server">
                <asp:DropDownList ID="dpd_usergrp" runat="server" CssClass="textbox2" Width="10px" OnSelectedIndexChanged="dpd_usergrp_SelectedIndexChanged" AutoPostBack="true"
                    >
                </asp:DropDownList>

                     <asp:DropDownList ID="dpd_user" runat="server" CssClass="textbox2" Width="10px"
                    >
                </asp:DropDownList>
                    </span>
            ...
            <td colspan="4"> 
                ...
                <asp:CheckBox ID="chk_Address" runat="server" Text="Add"/>
                <asp:CheckBox ID="chk_CardNo" runat="server" Text="Card No." Visible="false"/>
                <asp:CheckBox ID="chk_Passport" runat="server" Text="PassportExpiry"/>
                <asp:CheckBox ID="chk_DOB" runat="server" Text="DOB"/>
                <asp:CheckBox ID="chk_file_no" runat="server" Text="File No."/>

               
                <asp:CheckBox ID="chk_dtuser" runat="server" Text="DE Audit"/>
                <asp:CheckBox ID="chk_auth" runat="server" Text="Auth Audit"/>
                <asp:CheckBox ID="chk_prodUser" runat="server" Text="Prod Audit"/>
    ...
    <div id="R1" align="center" style="overflow: scroll; height:800px;"  runat="server" >
                ...
                <div id="DivReport" style="width: 800px;">
                        ...
                        <table style="width:100%;" align="center" id="tab1" runat="server">
                            <tr>
                                <td>&nbsp;</td>
                                <td align="center" colspan="4" style="font-size:large;">Datewise CardHolder Report</td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                   ...
                   for (int i = 0; i < objDs.Tables[0].Rows.Count; i++)
                  {
                           if (i>0)
                           {
                            ...
                            <tr class="Grid_Item_Alternaterow">
                                ...
                                <td align="left" valign="middle"> 
                                    <%=Convert.ToString(objDs.Tables[0].Rows[i]["passport_expiry_dateon"])%>
                                </td>
