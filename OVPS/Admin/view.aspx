<%@ page language="C#" autoeventwireup="true" inherits="Admin_view, App_Web_view.aspx.fdf7a39c" %>
            ...
            <table width="730" cellspacing="3" cellpadding="5" border="0" class="BackGround2">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type=button class = "open1 nextbutton" onclick="return Printwin();" /> 
                            ...
                            <asp:Button ID="btnUpdate" runat="server" CssClass="open1 nextbutton" Text="Modify Details"
