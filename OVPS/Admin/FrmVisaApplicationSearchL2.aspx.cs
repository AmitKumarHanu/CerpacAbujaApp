...
public partial class Admin_FrmVisaApplicationSearchL2 : System.Web.UI.Page
{
     #region "Declarations"
    ...
    protected void Bindgrid()
    {
        DataTable dt = null;
        dt = new DataTable();
        BusinessEntityLayer.BalVisaAppSearchL2 ObjBalVisasAppsearch = null;
        Label LabelMessage = (Label)this.Page.Master.FindControl("lblmsg");
        GridView1.Visible = false;
        try
        {
            ObjBalVisasAppsearch = new BusinessEntityLayer.BalVisaAppSearchL2();
