<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="FrmCompanyMaster.aspx.cs" Inherits="Admin_FrmCompanyMaster" %>
                    ...
                    <tr class="b11">
                        ...
                        <td align="left" style="width: 200px;">
                            <asp:RadioButtonList ID="rdOptionList" runat="server" OnSelectedIndexChanged="rdOptionList_SelectedIndexChanged" AutoPostBack="True" >
                                <asp:ListItem Value="0" Text="AO Form">AO &amp; AB Form</asp:ListItem>
