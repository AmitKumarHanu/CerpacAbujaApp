<%@ page language="C#" autoeventwireup="true" inherits="Admin_viewforcheckstatus" CodeFile="~/Admin/viewforcheckstatus.aspx.cs" %>
...
<body>
    ...
    <div class="wraper_app">
        ...
        <div id="first_step" class="scroll" width="600px">
            <img src="../Images/review.jpg" />
            <% if (dt.Rows.Count > 0)
               { %>
            <table width="600" cellspacing="3" cellpadding="5" border="0" class="BackGround2">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <%if (Convert.ToString(dt.Rows[0]["flagComplete"]) == "Y" && (Convert.ToString(dt.Rows[0]["PaymentMadeYN"]) == "0" || Convert.ToString(dt.Rows[0]["PaymentMadeYN"]) == ""))
                          { %>
                            <asp:Button ID="btnConfirm" runat="server" CssClass="open1 nextbutton" Text="Confirm & Make Payment" Width ="200px"
