<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile ="~/Admin/FrmApplicationDetailsForNew.aspx.cs" Inherits="Admin_FrmApplicationDetailsForNew" EnableEventValidation="true" %>
 ...
 <noscript>JAVASCRIPT IS DISABLED</noscript>
    ...
    <script type="text/javascript">
        ...
        function ValidateFirstName() {
            var PassportNumber = (document.getElemelntById('<%=TxtFirstName.ClientID%>'))
            if (PassportNumber.value.length == 0) {
                PassportNumber.style.borderColor = 'red';
  ...
  <script type="text/javascript">
      function buttonchange() {
          ...
          var ddob = document.getElementById('<%=TxtDob.ClientID%>').value;
          var cerpac_i_date = document.getElementById('<%=TxtIssueDate.ClientID%>').value;
          var doi = document.getElementById('<%=TxtDateOfIssue.ClientID%>').value;
          var objdoi = document.getElementById('<%=TxtDateOfIssue.ClientID%>');
          var cerdoi = document.getElementById('<%=TxtIssueDate.ClientID%>');
          var dop = new Date();
          dop = document.getElementById('<%=txt_purchase_date.ClientID%>');
         
          var x = dop.value.split('-')
          var y = cerdoi.value.split('-')
        ...
        //  alert(dop.value);
         //alert(doi);
          // alert(d); 
          // Change by Mr. gagan on date 11/12/13
          if (d > 1825 || d<0) {
              blnFalg = false;
              blnDoiFalg = false;
              objdoi.value = "";
              msg += "Cerpac Date of issue can be less than 5 Years or equal to of stamp date  \n";
          }
         
         // var getfillissuedate = now.setDate(dop.value + 90);
        //  alert(getfillissuedate);
          if (doi == "") {
              blnFalg = false;
              blnDoiFalg = false;
              msg += "Date of Issue \n";
              ...
              if (dtArray == null) {
                  ...
                  if (doi != "") {
                      if (process(doi) < process(ddob)) {
                          ...
                          blnFalg = false;
                          blnDoiFalg = false;
                          msg += "Passport Date of Issue should be greater than Date of Birth \n";
                          objdoi.value = "";
                          //return false;
                      }
//                      TxtDateOfIssue
     ...
     <script type="text/javascript">
         ...
         function AllowAlphabetForCompany() {
      ...
      function btnAccept_onclic() {
       ...
       <script language="javascript" type="text/javascript">
           ...
           function ShowPopUp(e) {
               var lbl=document.getElementById('<%=hidcerpac.ClientID%>');
               //alert(lbl.value);
         ...
         <script type="text/javascript">
             function showcalander(e) {
                 var maxdt = document.getElementById("<%=TxtIssueDate.ClientID%>").value
                 var ReturnValue = " ";
                 ReturnValue = window.showModalDialog("calpopup.aspx?maxdt=" + maxdt + "&start=0&end=1&add=0&cnt=2", e.paras, "dialogWidth=350px;dialogHeight=290px;scroll:no; status:no;")


                 var value = ReturnValue;
                 document.getElementById("<%=TxtExpDate.ClientID%>").value = value;

                 if (document.getElementById("<%=TxtExpDate.ClientID%>").value == 'undefined') {
                     document.getElementById("<%=TxtExpDate.ClientID%>").value = maxdt;
                 }
             }

             function showcalanderissue(e) {
                 var maxdt = document.getElementById("<%=TxtIssueDate.ClientID%>").value
                 var ReturnValue = " ";
                 ReturnValue = window.showModalDialog("calpopup.aspx?maxdt=" + maxdt + "&start=-5&end=0&add=-5&cnt=6", e.paras, "dialogWidth=350px;dialogHeight=290px;scroll:no; status:no;")


                 var value = ReturnValue;
                 document.getElementById("<%=TxtIssueDate.ClientID%>").value = value;
                 // alert(value);
                 if (document.getElementById("<%=TxtIssueDate.ClientID%>").value == 'undefined') {
                     document.getElementById("<%=TxtIssueDate.ClientID%>").value = maxdt;
                 }
...
.warning-box {
    ...
    <div id="Div_ContentPlaceHolder" align="center" class="bcolour">
     ...
     <a href="../icao.pdf" target="_blank" class="tooltip" title=" Click to view ICAO Photo Recommendations.">
           ...
           <img src="../img/img.png" alt="" id="fimg" name="fimg" class="fimg" style=" height:164px; top: 3%; left: 39%;  position:absolute; width:164px; border-radius: 6px; z-index: 2; border: 2px solid #000;" />
       
                                    <asp:Image runat="server" ID="ImgPhoto" ImageUrl="~/Images/Logo/default_logo.gif" style="height:164px; margin-left:8px; margin-top:9px; width:164px; border-width:0px; z-index:1;"  />
                    ...
                    <asp:Button ID="btnUploadPhoto"  runat="server" CssClass="nextbutton" 
                     ...
                     <asp:Button ID="btnUploadCancel" runat="server" CssClass="nextbutton" style="Height:25px;" Text="Cancel" onclick="btnUploadCancel_Click" UseSubmitBehavior="false" />&nbsp;&nbsp;  
                        <asp:Button ID="btnscanpic" runat="server" CssClass="nextbutton" Text="Scan Photo" UseSubmitBehavior="false" OnClick="btnscanpic_Click" /> 
                                    </div>
                                </td>
                            </tr>
                        </table>
...
<tr style="color:white;" class="b55"><td></td><td class="b77" id="bnkdata" runat="server"><strong>Bank Data</strong></td><td class="b77"><strong>From MRZ</strong></td><td class="b77"><strong>Proposed</td></tr>
...
<tr class="b55"><td  class="b55" align="left" >Middle Name</td><td id="bnkmname" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtMiddleNamebank" runat="server" CssClass="textbox2" AutoComplete="Off" Enabled="false" BackColor="#f0f0f0"></asp:TextBox>
                                </td><td>
...
<tr class="b55"><td  class="b55" align="left" >Nationality</td><td id="bnknationality" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtNationalitybank" runat="server" CssClass="textbox2" AutoComplete="Off" Enabled="false" BackColor="#f0f0f0"></asp:TextBox>
                                </td><td>
                                    ...
                                    <asp:DropDownList ID="TxtNationality" runat="server" CssClass="textbox2"  height="20px" width="130px"></asp:DropDownList>
                                <span class="star">*                           
                            </span>
                                     </td></tr>
                        ...
                        <table cellpadding="5" cellspacing="2" border="0" width="745px" id="detailtable" runat="server">
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="height:2px;">
                                <asp:TextBox ID="txtpob" runat="server" CssClass="textbox2" AutoComplete="Off" onkeyup="PlBnameAllowAlphabet()" onblur="ValidatePlaceOfBirth()" onkeydown="PlAllowSpecialChar"></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                     </td>
                            </tr>
                            <tr class="b55">
                                <td align="left" style="width: 150px;">
                                    Date of Birth</td>
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="TxtDob" runat="server" CssClass="textbox2" Width="128px" Height="18px" onkeyup="dtval(this,event)" AutoComplete="Off" Enabled="false" placeholder="DD-MM-YYYY"></asp:TextBox>
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="txtemailprsn" runat="server" CssClass="textbox2" onblur="checkEmail()" AutoComplete="Off"></asp:TextBox>
                                </td>
                                <td align="left" style="width: 150px;">
                                    Contact Number
                                </td>
                            ...
                            <tr class="t11">
                                <td colspan="4" align="center" style="height: 2px; display:none;">
                                    <asp:TextBox ID="txt_purchase_date" runat="server" CssClass="textbox2" Width="130px" Height="18px" Enabled="true" AutoComplete="Off"  placeholder="DD-MM-YYYY" ></asp:TextBox>
                                <asp:HiddenField ID="hidcerpac" runat="server" />
                                </td>
                            </tr>
                            ...
                            <tr  class="b55" >
                                ...
                                <td align="left" style="width: 190px;">
                                    ...
                                    <asp:TextBox ID="TxtIssueDate" runat="server" CssClass="textbox2" Width="130px" Height="18px" onkeyup="dtval(this,event)" Enabled="false" AutoComplete="Off"  placeholder="DD-MM-YYYY" OnTextChanged="TxtIssueDate_TextChanged" ></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                   <a id="A2" runat="server" href="javascript:NewCal('TxtIssueDate','DDMMMYYYY')">
                                <img alt="Pick a date" src="../Images/cal.jpg" style="border: 0"   /></a> <!--onclick="showcalanderissue(this);return false;" -->
                                </td>
                            </tr>
                            ...
                            <tr   class="b55">
                                ...
                                <td align="left" style="width: 190px;" >
                                    ...
                                    <asp:TextBox ID="TxtExpDate" runat="server" CssClass="textbox2" Enabled="false" Style="float:left;" Width="130px" Height="18px" AutoComplete="Off"  onkeyup="dtval(this,event)" placeholder="DD-MM-YYYY"></asp:TextBox>
                                <span class="star" style="width:40px;"> 

                                     <span style="vertical-align:middle; margin:-28px; margin-top: -11px;"> * </span>
                                    &nbsp;                         
                                     <asp:UpdatePanel style="width:25px; height:25px;  margin-top: -5px; margin-left:5px;  float:left;" ID="UpdatePanel1" runat="server"><ContentTemplate >
                                         &nbsp; &nbsp; 
                                     <a id="A3" runat="server" href="javascript:NewCal('TxtIssueDate','DDMMMYYYY')"> 
                                        
                                <img alt="Pick a date" src="../Images/cal.jpg" style="border-style: none; border-color: inherit; border-width: 0;"  /></a>
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" class="auto-style1"><asp:TextBox ID="txtZoneCode" runat="server" CssClass="textbox2" ReadOnly="true" ></asp:TextBox>
                                     <span class="star">*                           
                            </span>
                                </td>
                           <td align="left" class="auto-style1">
                                    File No</td>
                                <td align="left" class="auto-style1"><asp:TextBox ID="txtphyfileno" runat="server" CssClass="textbox2" ReadOnly="false" AutoComplete="Off" onblur="ValidateFileNo()" ></asp:TextBox>
                                     <span class="star">*                           
                            </span>
                                </td>
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;">
                                    ...
                                    <asp:TextBox ID="txtcompname" runat="server" CssClass="textbox2" onKeyPress="javascript: return false;" onKeyDown="javascript: return false;" onPaste="javascript: return false;" ></asp:TextBox>
                                       </a> 
                                 <span class="star">*       
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="txtcompadd1" runat="server" CssClass="textbox2" AutoComplete="Off" TextMode="MultiLine" onblur="Validatecompadd1()" AutoPostBack="false" OnTextChanged="txtcompadd1_TextChanged"></asp:TextBox>
                                 <span class="star">*                           
                            </span>
                                </td>
                                <td align="left" style="width: 150px;">
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="txtdtemploymnt" runat="server" CssClass="textbox2" Width="130px" Height="18px" onkeyup="dtval(this,event)" Enabled="false" AutoComplete="Off" placeholder="DD-MM-YYYY"></asp:TextBox>
            ...
            <tr class="b11">
                ...
                <td colspan="4" align="left" style="height: 20px;">
                    Address Abroad</td>
                        ...
                        <td align="left" style="height: 20px;">Address 2</td><td align="left">
                            ...
                            <tr><td colspan="4"></td></tr>
                             <tr class="b11">
                <td colspan="1" align="left" style="height: 20px;" class="b77">
                   <asp:Label runat="server" ID="lblpsnty" Text="Person Type"> </asp:Label></td>
                                 <td colspan="3" align="left">
                                     <asp:RadioButtonList ID="radtype" runat="server" RepeatColumns="1" AutoPostBack="True" OnSelectedIndexChanged="radtype_SelectedIndexChange">
                ...
                <td align="left" style="height: 20px;">
                  <asp:Label ID="lbldpndty" runat="server" Text=" Dependent on" Visible="false"></asp:Label></td>
                                 <td align="left"><asp:DropDownList ID="drpdpndt" runat="server" CssClass="textbox2" Visible="false"></asp:DropDownList>
                                     <asp:TextBox ID="txt_dpndt" runat="server" CssClass="textbox2" placeholder="Cerpac No." OnTextChanged="txt_dpndt_TextChanged" AutoPostBack="true" Visible="false"></asp:TextBox>

                                 </td>
                <td align="left">

                    <asp:Label ID="lbl_dept_name" runat="server" Text=" Name" Visible="false"></asp:Label>

                </td><td align="left">

                    <asp:Label ID="txt_dept_name" runat="server" Text="" Visible="false"></asp:Label>
                            ...
                            <tr class="b11">
                                <td align="left"><asp:Label ID="lbldeprel" runat="server" Text="Dependence Relation" Visible="false"></asp:Label></td>
                                <td align="left"><asp:DropDownList ID="drprltn" runat="server" CssClass="textbox2" Visible="false" OnSelectedIndexChanged="drprltn_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList></td>

                                <td></td>
                                <td><asp:TextBox ID="txt_depnt_peopleid" runat="server" Visible="false"></asp:TextBox></td>
...
<tr >
    ...
    <td align="left" colspan="3"><asp:TextBox ID="txtnotes" Style="resize:none;" runat ="server" Height="44px" AutoComplete="Off" Width="550px"  MaxLength="100" TextMode="MultiLine" Wrap="true"></asp:TextBox></td>
            </tr>
                            <tr class="b11">
                <td colspan="4" align="left" style="height: 20px;">
                </td>
                             ...
                             <tr >
                                 <td align="left" class="b77"><strong>Documents Attached</strong> </td>
            ...
            <tr class="b11">
                <td align="center" colspan="4">
                    <asp:Button ID="btnscanmrz" runat="server" CssClass="adminbutton" Text="Scan MRZ" OnClick="btnscanmrz_Click" UseSubmitBehavior="false"/> &nbsp;&nbsp;
                    <asp:Button ID="btngetdata" runat="server" CssClass="adminbutton" Text="Get Data from MRZ" Visible="false" OnClick="btngetdata_Click" UseSubmitBehavior="false" />&nbsp;&nbsp;
                    <asp:Button ID="btnverify" runat="server" class="adminbutton" Text="Verify" Width="140px" onclick="btnverify_Click" OnClientClick="return buttonchange();" />&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr><td align=center><div class="confirmation-box" height=10px style="display:none;"  id=confirm runat=server> <p style="color:#006600" id="p" runat=server><strong>Data Updated Sucessfully</strong></p>
            ...
            <br />
            <asp:Button ID="btnCheckSheet" runat="server" class="adminbutton" Text="Print Check Sheet" OnClick="btnCheckSheet_Click" />
