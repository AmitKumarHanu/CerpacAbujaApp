...
public partial class Admin_QualityCheck : System.Web.UI.Page
{
    ...
    protected void Bindlist()
    {
        ...
        //regarding zone
        //string queryforposition = "select forename as FirstName, middle_name as MiddleName, surname as  LastName, Company, Nationality, RequisitionNo, cerpac_file_no as FormNo, CerpacNo, Passport_No as PassportNo, isnull(StrVisaNo,'') as StrVisaNo, printed from vw_prod_consolidated_data where IsProduced=1 and (isqual=0 or isqual is null)";
