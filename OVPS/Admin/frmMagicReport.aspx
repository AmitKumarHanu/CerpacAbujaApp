<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" EnableEventValidation="false" ValidateRequest="false" CodeFile="frmMagicReport.aspx.cs" Inherits="Admin_frmMagicReport" %>
        ...
        <img alt="Pick a date" src="../Images/cal.jpg" style="border: 0" /></a> </span>
          ...
          <tr>
            ...
            <span id="sp2" runat="server">
                ...
                <asp:DropDownList ID="dpd_usergrp" runat="server" CssClass="textbox2" Width="170px" OnSelectedIndexChanged="dpd_usergrp_SelectedIndexChanged" AutoPostBack="true"
                    >
                </asp:DropDownList>

                     <asp:DropDownList ID="dpd_user" runat="server" CssClass="textbox2" Width="170px"
                    >
                </asp:DropDownList>
                    </span>
           </td>
                           ...
                           if (i>0)
                           {
                            ...
                            <tr class="Grid_Item_Alternaterow">
                                ...
                                <%} %>
                                 ...
                                 <td align="center" valign="middle"> 
                                    <%=Convert.ToString(objDs.Tables[0].Rows[i]["RecordStatus"])%>
                                </td>
                            </tr>
                          <%                             
