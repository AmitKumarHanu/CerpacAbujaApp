<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_QualityCheck" CodeFile="~/Admin/QualityCheck.aspx.cs" enableeventvalidation="false" %>
                                ...
                                <td align="right" style="width: 10%; vertical-align: middle; text-align: center;">
                                  ...
                                  <div style="background-image: url('../Images/back1.png'); height: 350px; width: 564px; border: 1px solid black; background-repeat:no-repeat;" align="center">
                                     <div id="container" style="position:relative;">
                                        <asp:Image ID="ImgPhoto" runat="server" Style="position:absolute; top: -270px;left: 50px; height: 163px; width: 149px;" />
                                         </div>
                                        <br />
                                      <br />
                                      <br />
