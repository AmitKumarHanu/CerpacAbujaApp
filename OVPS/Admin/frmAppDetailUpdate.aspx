<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_frmAppDetailUpdate, App_Web_frmappdetailupdate.aspx.fdf7a39c" %>
        ...
        <table cellpadding="2" cellspacing="5" class="bcolour" style="width: 95%" id="combox">
            ...
            <tr class="t11">
             ...
             <tr id="tr_cerpac" runat="server" >
                            <td align="center" style="height: 16px; width: 150px;" colspan="2">
                              <strong>  Enter CERPAC No.</strong> &nbsp;&nbsp;
...
<tr class="b55"><td  class="b55" align="left" >First Name</td><td id="bnkfname" runat="server">
    ...
    <td>
                                    <asp:TextBox ID="TxtFirstName" runat="server" CssClass="textbox2" onblur="ValidateFirstName()" AutoComplete="Off" onkeyup="AllowAlphabet()" onkeydown="AllowSpecialChar" Enabled="false"></asp:TextBox>
                                 <span class="star">*                           
                            </span>
    </td></tr>
<tr class="b55"><td  class="b55" align="left">Last Name</td><td id="bnklname" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtLastName" runat="server" CssClass="textbox2"  onblur="ValidateLastName()" AutoComplete="Off" onkeyup="lnameAllowAlphabet()" onkeydown="lAllowSpecialChar" Enabled="false"></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                     </td></tr>
...
<tr class="b55"><td  class="b55" align="left" >Middle Name</td><td id="bnkmname" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtMiddleName" runat="server" CssClass="textbox2"  AutoComplete="Off" onkeyup="MnameAllowAlphabet()" onkeydown="MAllowSpecialChar" Enabled="false"></asp:TextBox>
                                </td>
...
<tr class="b55"><td  class="b55" align="left" >Nationality</td><td id="bnknationality" runat="server">
                                    ...
                                    <asp:DropDownList ID="TxtNationality" runat="server" CssClass="textbox2"  Height="20px" Width="140px" Enabled="false"></asp:DropDownList>
                                 <span class="star">*                           
                            </span>
                                </td></tr>
