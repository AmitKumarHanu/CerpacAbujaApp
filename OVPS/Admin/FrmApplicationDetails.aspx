<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true"  CodeFile="FrmApplicationDetails.aspx.cs" Inherits="Admin_FrmApplicationDetails"
    Title="CERPAC Application Form" EnableEventValidation="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function validateCerExpDate() {
            ...
            var maxcurrV = document.getElementById("<%=txt_max_exp_date.ClientID%>");
  ...
  <script type="text/javascript">
      ...
      function buttonchange() {
          ...
          var maxcurrV = document.getElementById('<%=txt_max_exp_date.ClientID%>').value;
     ...
     <script language="javascript" type="text/javascript">
         ...
         function ShowPopUp(e) {
             ...
             var comp = document.getElementById("<%=oldcompname.ClientID%>").innerHTML;
             
             var compval = comp.split(' ');
             ...
             var ReturnValue = window.showModalDialog("CompanyPopUp.aspx?val=" + compval[0] + "&no=" + lbl.value, e.paras, "dialogWidth=450px;dialogHeight=500px;scroll:no; status:no;")
...
<tr class="b55"><td  class="b55" align="left" >First Name</td><td id="bnkfname" runat="server">
    ...
    <td>
                                    <asp:TextBox ID="TxtFirstName" runat="server" CssClass="textbox2" Enabled="false"></asp:TextBox>
                                 <span class="star">*                           
                            </span>
    </td></tr>
<tr class="b55"><td  class="b55" align="left">Last Name</td><td id="bnklname" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtLastName" runat="server" CssClass="textbox2"  Enabled="false"></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                     </td></tr>
...
<tr class="b55"><td  class="b55" align="left" >Middle Name</td><td id="bnkmname" runat="server">
                                    ...
                                    <asp:TextBox ID="TxtMiddleName" runat="server" CssClass="textbox2"  AutoComplete="Off" Enabled="false"></asp:TextBox>
                                </td>
...
<tr class="b55"><td  class="b55" align="left" >Nationality</td><td id="bnknationality" runat="server">
                        ...
                        <table cellpadding="5" cellspacing="2" border="0" width="745px" id="detailtable" runat="server">
                            ...
                            <tr class="t11">
                               ...
                               <asp:HiddenField ID="hidissue" runat="server" />
                                     </td>
                            </tr>
                            <tr  class="b55" >
                                <td align="left" style="width: 150px;" >
                                ...
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="TxtIssueDate" runat="server" CssClass="textbox2" Width="130px" Height="18px" onkeyup="" AutoComplete="Off" Enabled="false" placeholder="DD-MM-YYYY"></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                     
                                <img alt="Pick a date" src="../Images/cal.jpg" style="border: 0" />
                                </td>
                            </tr>
                            ...
                            <tr  class="b55" >
                                ...
                                <td align="left" style="width: 190px;" >
                                    ...
                                    <asp:TextBox ID="TxtExpDate" runat="server" Style="float:left;" CssClass="textbox2" Enabled="false" Width="130px" Height="18px" AutoComplete="Off"   placeholder="DD-MM-YYYY"></asp:TextBox><!--onkeyup="dtval(this,event)" -->
                            ...
                            <tr class="t11">
                             ...
                             <tr class="t11">
                                <td  align="center" style="height: 2px;">
                                   ...
                                   <td  align="left" style="height: 2px; text-decoration:blink;font-weight:bold;" runat="server" id="oldcompname">
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;">
                                    <asp:TextBox ID="txtcompid" runat="server" CssClass="textbox2" AutoComplete="Off" onkeypress="return false;"></asp:TextBox>
                                </td>
                                <td align="left" style="width: 150px;">
                                    Company Name
                                </td>
                                <td align="left" style="width: 190px;">
                                    ...
                                    <asp:TextBox ID="txtcompname" runat="server" CssClass="textbox2" AutoComplete="Off" AutoPostBack="true" onKeyPress="javascript: return false;" onKeyDown="javascript: return false;" onPaste="javascript: return false;"   Enabled="true"></asp:TextBox>
                                        <%--</ContentTemplate></asp:UpdatePanel>--%>
                                 <span class="star">*  
                                     </a>
                ...
                <td align="left">
                    ...
                    <asp:Label ID="txt_dept_name" runat="server" Text="" Visible="false"></asp:Label>
                            ...
                            <tr style="display:none;">
                                <td colspan="4">
                                <asp:TextBox ID="txt_max_exp_date" runat="server" ></asp:TextBox>
                                </td>
                            </tr>
    ...
    <td align="left" colspan="3"><asp:TextBox ID="txtnotes" Style="resize:none;" runat ="server" Height="44px" AutoComplete="Off" Width="550px" MaxLength="100" Wrap="true" TextMode="MultiLine"></asp:TextBox></td>
            ...
            <tr class="b11">
                <td align="center" colspan="4">
                    ...
                    <asp:Button ID="btnverify" runat="server" class="adminbutton" Text="Verify" Width="140px" onclick="btnverify_Click" OnClientClick="javascript:return buttonchange();" />&nbsp;&nbsp;&nbsp;&nbsp;<!--OnClientClick="javascript:return buttonchange();"-->
