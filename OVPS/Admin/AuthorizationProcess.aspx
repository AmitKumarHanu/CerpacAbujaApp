<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="AuthorizationProcess.aspx.cs" Inherits="Admin_AuthorizationProcess"  EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center><div align=center class="confirmation-box" height=10px style="margin-top: 30px; display:none;" id=confirm  runat=server><p style="color:#006600" id="p" runat=server><strong>Applicant Authorized Sucessfully</strong></p></div></center>
            ...
            <tr>
                <td colspan="3" style="height: 5px">
                    <div class="PageNameHeadingCSS" style="text-align: center">
                        <font class="b12"><span style="font-size: 16px; color:White;">&nbsp;Authorization Process &nbsp; </span>
                        </font>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td align="center">
                    <table class="t11" style="width: 100%;" >
                        <tr>
                            <td align="center" style="height: 16px; width: 100%">
                               <strong>CERPAC No </strong><span style="font-size:12px;"><strong >(Secured Sold Form No. in case of new case)</strong></span> &nbsp;&nbsp;
                                <asp:TextBox ID="TextAppId" runat="server" AutoComplete="Off" ValidationGroup="a" Width="150px" CssClass="textbox2"
                                    Height="20px"></asp:TextBox>&nbsp; <span style="color: red; text-align: center; font-size: medium;">
                                        *</span>
                                <asp:RequiredFieldValidator ID="rfvAppId" runat="server" ControlToValidate="TextAppId" Display="None" ErrorMessage="Application ID" ValidationGroup="a" SetFocusOnError="True"   ForeColor="#9EC550"></asp:RequiredFieldValidator>&nbsp;
                             </td>
                            <td>      <asp:Button ID="Go" runat="server"  Text="Search" class="adminbutton" ValidationGroup="a"  OnClick="Go_Click" OnClientClick="change(1)" />
                         </td>
                        </tr>
...
<PagerStyle CssClass="pgr"></PagerStyle>
                     ...
                     <asp:Button ID="btnauth" runat="server" CssClass="adminbutton" Text="Authorize" 
                        OnClientClick="change(2)" onclick="btnauth_Click" Visible="false"  />&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnreject" runat="server" CssClass="adminbutton" Text="Deny" 
                        OnClientClick="change(3)" onclick="btnreject_Click" Visible="false" />
                </td>
            </tr>
        </table>
    </div>
