<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_ApplicationProcessForNew, App_Web_applicationprocessfornew.aspx.fdf7a39c" %>
                        ...
                        <tr><td class="auto-style3"></td>
                            ...
                            <td align="left" class="auto-style2">
                                <asp:TextBox ID="TextAppId" runat="server" AutoComplete="Off" Width="196px" CssClass="txtbox"
                                    Height="26px" onkeyup="claschnge()" MaxLength="8"></asp:TextBox>&nbsp; 
                                </td>
                            <td></td>
                        </tr>
