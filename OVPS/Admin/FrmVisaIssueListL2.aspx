<%@ page language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_FrmVisaIssueListL2" CodeFile="~/Admin/FrmVisaIssueListL2.aspx.cs" title="Visa issue List" %>
...
<div  align="center">
    ...
    <table cellpadding="2" cellspacing="10" style="border:1px solid #dddddd; width:95%">
      <tr>
        <td colspan="2" class="PageNameHeadingCSS_2" align="center"> Visa issue List L2 </td>
       </tr>
	       ...
	       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" 
                            Width="13%" />
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" Width="13%" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Passport No">
                    <HeaderStyle HorizontalAlign="Center" Width="13%" />
                    <ItemStyle HorizontalAlign="Left" Wrap="False" Width="13%" />
                    <ItemTemplate>
               ...
               <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" 
                    ...
                    <asp:BoundField DataField="FinalVisaIssuedYN" HeaderText="Visa Status">
                        <HeaderStyle HorizontalAlign="Center" Width="13%" />
                        <ItemStyle HorizontalAlign="Center" Width="13%" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Approver2Status" HeaderText="Final Status">
                        <HeaderStyle HorizontalAlign="Center" Width="13%" />
                        <ItemStyle HorizontalAlign="Center" Width="13%" />
                    </asp:BoundField>
