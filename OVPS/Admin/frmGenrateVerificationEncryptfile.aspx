<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="frmGenrateVerificationEncryptfile.aspx.cs" Inherits="Admin_frmGenrateVerificationEncryptfile" %>
 ...
 <tr>                
                <td colspan="3" style="height: 5px">
                    <div class="PageNameHeadingCSS" style="text-align: center">
                         <font class="b12"><span style="font-size: 16px; color:White;">&nbsp; Create Encrypt File After Confirm Eligibility &nbsp; </span>
                        </font>
                    </div>
                </td>
            </tr>
...
<td style="height: 5px; width: 90%; text-align: left;"  >
 ...
 <div id="DivZonelist" align="center" class="bcolour"  runat="server">
              <table cellpadding="2" cellspacing="10" style="width: 95%"   >
                    <tr>
                     <td align="left" style="width: 150px; text-align:right" >
                                    Zone Name
                                </td>
                    <td align="left" style="width: 150px; text-align:left"> 
                          <asp:DropDownList ID="cmdZoneList" runat="server" CssClass="textbox2"  
                              Height="20px" Width="140px"></asp:DropDownList>
                                </td>
                    <td align="left" style="width: 150px; text-align:left">
                        <asp:Button ID="btnDetails" runat="server"  Text="Search" class="adminbutton" onclick="btnDetails_Click" 
...
<tr >
<td align= "left"  style="border-right: 2px dashed #000; border-left: 2px dashed #000;"><strong>Total Response Form's</strong> </td>
<td align= "left"  style="border-right: 2px dashed #000;"><strong>Confimed</strong> </td>
<td align= "left"  style="border-right: 2px dashed #000;"><strong>Rejected</strong></td>
<td align= "left"  style="border-right: 2px dashed #000;"><strong>Deny Completely</strong></td>


</tr>
<tr class="b77">
<td align="center" style="border: 2px dashed #000; " class="b55 b-lt "><asp:Label ID="lblTotalResponse" runat="server"></asp:Label></td>
<td align="center" style="border: 2px dashed #000;" class="b55 b-lt "><asp:Label ID="lblComfirmed" runat="server"></asp:Label></td>
<td align="center" style="border: 2px dashed #000;" class="b55 b-lt "><asp:Label ID="lblReject" runat="server"></asp:Label></td>
<td align="center" style="border: 2px dashed #000;" class="b55 b-lt "><asp:Label ID="lblDeny" runat="server"></asp:Label></td>
