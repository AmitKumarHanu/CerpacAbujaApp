...
public partial class Admin_FrmVisaApplicationSearchL1 : System.Web.UI.Page
{
    #region "Declarations"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        FromDate.HRef = "javascript:NewCal('" + TextFromDate.ClientID + "','DDMMMYYYY','','',20,20)";
        Todate.HRef = "javascript:NewCal('" + TextToDate.ClientID + "','DDMMMYYYY','','',20,20)";
    ...
    protected void Bindgrid()
    {
        DataTable dt = null;
        dt = new DataTable();
        BusinessEntityLayer.BalVisaAppSearchL1 ObjBalVisasAppsearch = null;
        Label LabelMessage = (Label)this.Page.Master.FindControl("lblmsg");
        GridView1.Visible = false;
        try
        {
            ObjBalVisasAppsearch = new BusinessEntityLayer.BalVisaAppSearchL1();
