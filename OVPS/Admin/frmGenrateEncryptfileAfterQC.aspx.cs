    ...
    protected void btnEncrypt_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            try
            {
                ...
                "FROM   People where cerpac_no in ('" + ViewState["CerpacList"].ToString().Trim().Replace(",", "','") + "')";
             ...
             " up_f FROM   people as a  , PeopleChild as b where a.cerpac_no=b.CerpacNo and  b.cerpacno in ('" + ViewState["CerpacList"].ToString().Trim().Replace(",", "','") + "') and b.IsVerified=1 and b.IsAuthorized=1 and b.ISARCR=1 and b.IsProduced=1 and b.IsQual=1 and isnull(b.IsBrown,0)=0 and isnull( b.IsRejected,0 )=0";
