...
public partial class Admin_frmApplicantTracking : System.Web.UI.Page
{
        #region "Declarations"
    ...
    protected void GoPrev_Click(object sender, ImageClickEventArgs e)
    {
        //----------------------Flag and Auditing-----------------------
        Label LabelMessage = (Label)this.Page.Master.FindControl("lblmsg");
        objGeneral = new BaseLayer.General_function();
        ...
        try
        {
            ...
            {
                int statusid = GoFlag();
                Message = "Production flag successfully Changed";
                if (statusid == 1)
                {
                    LabelMessage.Visible = true;
    ...
    public int GoFlag()
    {
        ...
        try
        {
            pram[0] = new SqlParameter("@CerpacNo", lblCerpacExpDt.Text.ToString().Trim());
            pram[1] = new SqlParameter("@FormNo", lblCerpacNo.Text.ToString().Trim());
            pram[2] = new SqlParameter("@UpdatedBy", UserID);
            pram[3] = new SqlParameter("@Opt", 1);
    ...
    protected void AdminRej_Click(object sender, ImageClickEventArgs e)
    {
