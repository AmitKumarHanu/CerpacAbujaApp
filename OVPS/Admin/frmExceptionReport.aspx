<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="frmExceptionReport.aspx.cs" EnableEventValidation="false" Inherits="Admin_frmExceptionReport" %>
...
<script type="text/javascript">
    ...
    function process(date) {
        ...
        <img alt="Pick a date" src="../Images/cal.jpg" style="border: 0" /></a> </span>
          ...
          <td><br /></td>
            ...
            <td colspan="4"> 
                ...
                <asp:CheckBox ID="chk_prodUser" runat="server" Text="Production Audit" Visible="false"/>
                <asp:CheckBox ID="chk_qualuser" runat="server" Text="Qual Audit" Visible="false"/>
     ...
     <div id="R1" align="center" style="overflow: scroll; height:auto;"  runat="server" >
         ...
         <div>
 <table style="width:100%; display:none;" align="center" >
                            <tr>
                                <td>&nbsp;</td>
                                <td align="left" colspan="2">
                                    <asp:Label ID="lbl_formno"  runat="server" Text="Fill Form No. (Seperated By Comma(,)):" Font-Bold="true"></asp:Label>
                                     <asp:TextBox ID="txt_formNo" runat="server" Width="213px"></asp:TextBox></td>

                               
                                <td align="left" colspan="2">
                                    <asp:Button ID="btn_noexception" runat="server" class="adminbutton" Text="No Exception" OnClick="btn_noexception_Click" />
                                    </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                ...
                <div id="DivReport" style="width: 800px;">
                        ...
                        <table style="width:100%;" align="center">
                            <tr>
                                <td>&nbsp;</td>
                                <td align="center" colspan="4" >Datewise Exception Report</td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
...
&nbsp;TO&nbsp;<asp:Label ID="lblTDate" runat="server"></asp:Label>
                       ...
                       <%
                           if (objDs.Tables.Count > 0)
                          {
                              ...
                              { %>
                        <table class="GridBaseStyle"   border="1" cellspacing="1"  rules="all" style="width: 90%; height:200px; overflow: scroll; clip: rect(auto, auto, auto, auto);">
                            
                            <tr class="Grid_Header">
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle" colspan="5">Purchased By</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle" colspan="8">Issued To</th>

                            </tr>
                            <tr class="Grid_Header">
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">S.N.</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Form_No</th>                                
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">First_Name_Bank</th>                                
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Last_Name_Bank</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Nationality_Bank</th>

                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Frist_Name_DB </th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Last_Name_DB</th>                                
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Nationality_DB</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">DataEntryUser</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">DataEntryOn</th>

                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">AuthBy </th>                                
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Auth On</th> 
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">ContecBy</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">ContecOn</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">ProdBy</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">ProdOn</th>
                                ...
                                <td align="left" valign="middle"> 
                                    <%=Convert.ToString(i+1)%>
                                       ...
                                       <td align="center" valign="middle">
                                         <%=Convert.ToString(objDs.Tables[0].Rows[i]["Form_No"])%>
                                </td>
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["First_Name_Bank"])).ToUpper()%>
                                </td>
                                      
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["Last_Name_Bank"])).ToUpper()%>
                                </td>
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["Nationality_Bank"])).ToUpper()%>
                                </td>

                                      

                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["Frist_Name_DB"])).ToUpper()%>
                                </td>

                                         <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["Last_Name_DB"])).ToUpper()%>
                                </td>
                                      
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["Nationality_DB"])).ToUpper()%>
                                </td>
                                 ...
                                 <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["DataEntryOn"])).ToUpper()%>
                                </td>
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["AuthBy"])).ToUpper()%>
                                </td>
                                                                           
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["AuthorizedOn"])).ToUpper()%>
                                </td>
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["ContecBy"])).ToUpper()%>
                                </td>
                                      <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["ContecVerifyOn"])).ToUpper()%>
                                </td>
                                      <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["ProdBy"])).ToUpper()%>
                                </td>
                                      <td align="left" valign="middle">
                                       ...
                                       <%--<td align="left" valign="middle">
                                           ...
                                           <asp:Button ID="btn_ex" runat="server" Text="No Exception" ToolTip='<%#(Convert.ToString(objDs.Tables[0].Rows[0]["surname"])).ToUpper()%>' />
