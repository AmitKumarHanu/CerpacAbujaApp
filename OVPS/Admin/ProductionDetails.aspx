<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageUser.master" AutoEventWireup="true" CodeFile="ProductionDetails.aspx.cs" Inherits="Admin_ProductionDetails" %>
...
<asp:Label ID="txt_place_of_issue_7" runat="server" Text="Abuja" Font-Size="X-Small" Font-Bold="true"></asp:Label></td>
 ...
 <td style="font-size:X-Small;" valign="bottom"></td>
    ...
    <td  rowspan="6" valign="middle" align="left" class="auto-style2">
     ...
     <asp:Label ID="Label5" runat="server" Text="Name"  Font-Size="X-Small" ForeColor="DarkGreen"></asp:Label>
    <br />
        <asp:Label ID="txt_name_1" runat="server" Text="Saurabh Bansal" Font-Size="X-Small" style="word-wrap:break-word;" Font-Bold="true"></asp:Label>
    </td>
    ...
    <td class="style11" colspan="2">
     ...
     <asp:Label ID="lbl_comp" runat="server" Text="Company" valign="top"  Font-Size="X-Small" ForeColor="DarkGreen"></asp:Label>
    <br />
        <asp:Label ID="txt_comp" runat="server" Text="Sample" Font-Size="X-Small" style="word-wrap:break-word; " Font-Bold="true"></asp:Label>
    </td>
