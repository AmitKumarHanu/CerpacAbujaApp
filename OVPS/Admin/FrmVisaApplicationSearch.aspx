<%@ page language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_FrmVisaApplicationSearch" CodeFile="~/Admin/FrmVisaApplicationSearch.aspx.cs" title="Visa Application Search L3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<%--<asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>--%>    <div  align="center">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">  
    <ContentTemplate>
        <table cellpadding="2" cellspacing="10" style="border:1px solid #dddddd; width:95%">
    <tr>
        <td colspan="2"  class="PageNameHeadingCSS_2" align="center">Visa Application Search
            L3</td>
    </tr>     
    <tr>
                    ...
                    <tr class="b11">
                        <td align="center" colspan="4">
                            &nbsp;<asp:Button ID="Search" runat="server" Text="Search" Width="120px" 
                                onclick="Search_Click" CssClass="button" /></td>
                    </tr>
            ...
            <asp:TemplateField HeaderText="Passport No">
             ...
             <asp:TemplateField HeaderText="Applicant Name">
               ...
               <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                ...
                <asp:TemplateField HeaderText="L3 Status " >
                    <ItemTemplate>
                        <asp:Label ID="lblStatusL2" runat="server" Text='<%# Bind("Approver3Status") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Paper Visa " >
                    <ItemTemplate>
                        <asp:Label ID="lblStatusL3" runat="server" Text='<%# Bind("PaperVisaIssuedYN") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                </asp:TemplateField>
