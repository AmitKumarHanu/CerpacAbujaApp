<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_ProductionDetailBrownCard" CodeFile="~/Admin/ProductionDetailPrintBrownCard.aspx.cs" %>
...
body { margin: 0px; } 
  ...
  <script type="text/javascript" src="../engine1/wowslider.js"></script>
    ...
    <SCRIPT>
     ...
     <script type = "text/javascript">
         var TestVar = document.getElementById('ctl00_ContentPlaceHolder1_comp_c');
        // alert(TestVar);


         var f2 = document.getElementById('ctl00_ContentPlaceHolder1_company');
             f2.value = f1.value;
...
<%--<tr>
    ...
    <td >
      ...
      <tr style="height:38px; line-height:8px;">
...
<div id="container" style="position:relative;">                              
 <asp:Image ID="ImgPhoto" runat="server" Style="position:absolute;top: 60px;left: 40px;height: 163px;width: 149px;" />
</div>
<table style="width: 53%;">
    ...
    <br /><br />           <br />       <br />   
                                 ...
                                 <!--
                                  ...
                                  <td style="width: 128px"></td>
                                  <td style="text-align: left">
                                 <!--<input id="company" value="" name="company" /> -->
                                    <asp:Label ID="company" runat="server" Text="" style="color: #FFFFFF"></asp:Label>
                                ...
                                <td align="right" style="width: 10%; vertical-align: middle; text-align: center;">
                                 ...
                                 <br /><br /><br />
                                  <table style="width: 40%;">
                                   <tr>
                                   <td align="left"><font size="-3"> Cerpac No.</font></td>
