...
public partial class Admin_viewforcheckstatus : System.Web.UI.Page
{
    ...
    {       
        ...
        if (Request.QueryString["AppID"] != null)
        {
            ...
            Trace.Warn("Convert.ToString(dt.Rows[0][flagComplete]) " + Convert.ToString(dt.Rows[0]["flagComplete"]));
            Trace.Warn("Convert.ToString(dt.Rows[0][PaymentMadeYN]) " + Convert.ToString(dt.Rows[0]["PaymentMadeYN"]));  
