		...
		<div class="wraper_hm">
			...
			<div class="cont_hmtp">
				<div class="cont_hmtplft_int">
					<font style="color:#9f0109;font-size:18px;">Frequently Asked Questions</font> <br/><br/>
...
If your payment method is Interswitch - go to Interswitch Quickteller, you can use the service to view payment made with the card. To use the service just follow the instruction prompts on the website. If payment is confirmed then Send an email to <a href="mailto:nis-support@socketworksng.com">nis-support@socketworksng.com</a>  with your Full name, reference number, application ID, payment method used and the Debit Card number (do not send your card PIN please) explaining the situation.
<br />For other payment types please also email the above address explaining the situation.
    ...
    <li>
      ...
      <div class='faA'>Send an email to <a href="mailto:nis-support@socketworksng.com">nis-support@socketworksng.com</a> with your full name, scanned passport photograph, email address, date of birth.
