...
function MakeAlert(){
    ...
    var conf = confirm("Your application will be considered incomplete \n for  initiating processing of the application you \n are  advised to complete application and submit it.");
