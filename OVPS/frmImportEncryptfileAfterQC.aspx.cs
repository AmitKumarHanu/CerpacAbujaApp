...
public partial class Admin_frmImportEncryptfileAfterQC : System.Web.UI.Page
{
    ...
    public void SplitString()
    {
        try
        {
                ...
                for (int i = 1; i <= PeopleCount.Count() - 2; i++)
                {
                    ...
                    var PeopleRowCount = PeopleRow.Split(stringSeparatorsPeopleRow, StringSplitOptions.None);
                        ...
                        if (dt.Rows[0].ItemArray[0].ToString()  != "0")
                        {
                            ...
                            SqlCommand Command = new SqlCommand("update People set forename ='" + PeopleRowCount[2].Trim() + "', middle_name ='" + PeopleRowCount[3].Trim() + "', surname ='" + PeopleRowCount[4].Trim() + "', sex ='" + PeopleRowCount[5].Trim() + "', cerpac_file_no ='" + PeopleRowCount[16].Trim() + "', cerpac_expiry_date ='" + datep(PeopleRowCount[18].Trim()) + "', cerpac_receipt_date ='" + datep(PeopleRowCount[17].Trim()) + "', passport_no ='" + PeopleRowCount[24].Trim() + "', nationality ='" + PeopleRowCount[25].Trim() + "', company ='" + PeopleRowCount[38].Trim() + "', designation= '" + PeopleRowCount[41].Trim() + "' where cerpac_no = '" + PeopleRowCount[15].Trim() + "'", Connection);
                            Connection.Open();
                ...
                for (int i = 1; i <= PeopleChildCount.Count() - 2; i++)
                {
                    ...
                    var PeopleChildRowCount = PeopleChildRow.Split(stringSeparatorsPeopleChildRow, StringSplitOptions.None);
                        ...
                        if (dt.Rows[0].ItemArray[0].ToString()  != "0")
                        {
                            ...
                            SqlCommand Command = new SqlCommand("update PeopleChild set  IsVerified ='" + PeopleChildRowCount[15].Trim() + "', IsAuthorized ='" + PeopleChildRowCount[16].Trim() +  "', ISARCR='" + PeopleChildRowCount[35].Trim() + "',ConfirmedBy='" + PeopleChildRowCount[36].Trim() + "',ConfirmedOn='" + datep(PeopleChildRowCount[37].Trim()) +"', IsProduced ='" + PeopleChildRowCount[17].Trim() + "', VerifiedBy ='" + PeopleChildRowCount[18].Trim() + "', AuthorizedBy ='" + PeopleChildRowCount[19].Trim() + "', ProducedBy ='" + PeopleChildRowCount[20].Trim() + "', ProducedOn ='" + datep(PeopleChildRowCount[21].Trim()) + "', AuthorizedOn='" + datep(PeopleChildRowCount[22].Trim()) + "', VerifiedOn ='" + datep(PeopleChildRowCount[23].Trim()) + "', IsRejected ='" + PeopleChildRowCount[24].Trim() + "', RejectedBy ='" + PeopleChildRowCount[25].Trim() + "', RejectedOn ='" + datep(PeopleChildRowCount[26].Trim()) + "', RejectionReason  ='" + PeopleChildRowCount[27].Trim() + "',cerpac_expiry_date ='" + datep(PeopleChildRowCount[38].Trim()) + "', cerpac_receipt_date ='" + datep(PeopleChildRowCount[39].Trim()) + "', IsQual ='" + PeopleChildRowCount[40].Trim() + "', QualBy ='" + PeopleChildRowCount[41].Trim() + "', QualOn ='" + datep(PeopleChildRowCount[42].Trim()) + "', BrownOn ='" + datep(PeopleChildRowCount[43].Trim()) + "', BrownBY ='" + PeopleChildRowCount[44].Trim() + "', IsBrown ='" + PeopleChildRowCount[45].Trim() + "', IsStickerPrinted ='" + PeopleChildRowCount[46].Trim() + "', StickerPrintedBy ='" + PeopleChildRowCount[47].Trim() + "', StickerPrintedOn ='" + datep(PeopleChildRowCount[48].Trim()) + "' where cerpacno in ('" + PeopleChildRowCount[7].Trim() + "') and formno='" + PeopleChildRowCount[4].Trim() + "'", Connection);
                            Connection.Open();
                            Command.ExecuteNonQuery();
                            Connection.Close();
            ...
            //---------------------Issue table----------------
                //String Issue = lines[7];
                //string[] stringSeparatorsIssue = new string[] { "-###-" };
                //var IssueCount = Issue.Split(stringSeparatorsIssue, StringSplitOptions.None);
                ...
                //for (int i = 1; i <= IssueCount.Count() - 2; i++)
                //{
                //    String IssueRow = IssueCount[i]; // lines[2];
                //    string[] stringSeparatorsIssueRow = new string[] { "\t" };

                //    var IssueRowCount = IssueRow.Split(stringSeparatorsIssueRow, StringSplitOptions.None);

                //    //-----------------Search in Issue  table--------------------
                //    objgenenral = new BaseLayer.General_function();
                //    string QuerCountFound = "select count(*) from Issue where cerpac_no='" + IssueRowCount[11].Trim() + "' and cerpac_file_no='" + IssueRowCount[12].Trim() + "'";

                //    DataTable dt = new DataTable();
                //    dt = objgenenral.FetchData(QuerCountFound);
                //    if (dt.Rows[0].ItemArray[0].ToString() == "0")
                //    {
                //        SqlCommand CommandZone = new SqlCommand("insert into issue (deedmark_no,people_id,issue_no,reason,title,forename,middle_name,surname,sex,residence_permit_no,"
                //           + " residence_issue_loc,cerpac_no,cerpac_file_no,cerpac_receipt_date,cerpac_expiry_date,registration_area,registration_code,file_no,passport_no,nationality,"
                //           + " passport_issue_date,passport_expiry_date,passport_issue_loc,passport_issue_by,date_of_birth,place_of_birth,nigeria_add_1,nigeria_add_2,nigeria_tel_no,abroad_add_1,"
                //           + " abroad_add_2,abroad_tel_no,company,company_add_1,company_add_2,designation,employment_date, company_tel_no,company_fax_no,email,verid_template,"
                //           + " verid_template_1,date_issued,issued_by_user_id) "
                //           + " values((select isnull(max(cast (deedmark_no as bigint)),0)+1 from Issue),'" + IssueRowCount[1].Trim() + "','" + IssueRowCount[2].Trim() + "','" + IssueRowCount[3].Trim() + "','" + IssueRowCount[4].Trim() + "','" + IssueRowCount[5].Trim() + "','" + IssueRowCount[6].Trim() + "','" + IssueRowCount[7].Trim() + "','" + IssueRowCount[8].Trim() + "','" + IssueRowCount[9].Trim() + "','"
                //           + IssueRowCount[10].Trim() + "','" + IssueRowCount[11].Trim() + "','" + IssueRowCount[12].Trim() + "','" + IssueRowCount[13].Trim() + "','" + IssueRowCount[14].Trim() + "','" + IssueRowCount[15].Trim() + "','" + IssueRowCount[16].Trim() + "','" + IssueRowCount[17].Trim() + "','" + IssueRowCount[18].Trim() + "','" + IssueRowCount[19].Trim() + "','"
                //           + IssueRowCount[20].Trim() + "','" + IssueRowCount[21].Trim() + "','" + IssueRowCount[22].Trim() + "','" + IssueRowCount[23].Trim() + "','" + IssueRowCount[24].Trim() + "','" + IssueRowCount[25].Trim() + "','" + IssueRowCount[26].Trim() + "','" + IssueRowCount[27].Trim() + "','" + IssueRowCount[28].Trim() + "','" + IssueRowCount[29].Trim() + "','"
                //           + IssueRowCount[30].Trim() + "','" + IssueRowCount[31].Trim() + "','" + IssueRowCount[32].Trim() + "','" + IssueRowCount[33].Trim() + "','" + IssueRowCount[34].Trim() + "','" + IssueRowCount[35].Trim() + "','" + IssueRowCount[36].Trim() + "','" + IssueRowCount[37].Trim() + "','" + IssueRowCount[38].Trim() + "','" + IssueRowCount[39].Trim() + "','"
                //           + IssueRowCount[40].Trim() + "','" + IssueRowCount[41].Trim() + "','" + IssueRowCount[42].Trim() + "','" + IssueRowCount[43].Trim() + "')", ConnectionZone);
                ...
                //    else
                //    {
                //        //SqlCommand CommandZone = new SqlCommand("Update issue Set (deedmark_no,people_id,issue_no,reason,title,forename,middle_name,surname,sex,residence_permit_no,"
                //        //   + " residence_issue_loc,cerpac_no,cerpac_file_no,cerpac_receipt_date,cerpac_expiry_date,registration_area,registration_code,file_no,passport_no,nationality,"
                //        //   + " passport_issue_date,passport_expiry_date,passport_issue_loc,passport_issue_by,date_of_birth,place_of_birth,nigeria_add_1,nigeria_add_2,nigeria_tel_no,abroad_add_1,"
                //        //   + " abroad_add_2,abroad_tel_no,company,company_add_1,company_add_2,designation,employment_date, company_tel_no,company_fax_no,email,verid_template,"
                //        //   + " verid_template_1,date_issued,issued_by_user_id) "
                //        //   + " values((select isnull(max(cast (deedmark_no as bigint)),0)+1 from Issue),'" + IssueRowCount[0].Trim() + "','" + IssueRowCount[1].Trim() + "','" + IssueRowCount[2].Trim() + "','" + IssueRowCount[3].Trim() + "','" + IssueRowCount[4].Trim() + "','" + IssueRowCount[5].Trim() + "','" + IssueRowCount[6].Trim() + "','" + IssueRowCount[7].Trim() + "','" + IssueRowCount[8].Trim() + "','" + IssueRowCount[9].Trim() + "','"
                //        //   + IssueRowCount[10].Trim() + "','" + IssueRowCount[11].Trim() + "','" + IssueRowCount[12].Trim() + "','" + IssueRowCount[13].Trim() + "','" + IssueRowCount[14].Trim() + "','" + IssueRowCount[15].Trim() + "','" + IssueRowCount[16].Trim() + "','" + IssueRowCount[17].Trim() + "','" + IssueRowCount[18].Trim() + "','" + IssueRowCount[19].Trim() + "','"
                //        //   + IssueRowCount[20].Trim() + "','" + IssueRowCount[21].Trim() + "','" + IssueRowCount[22].Trim() + "','" + IssueRowCount[23].Trim() + "','" + IssueRowCount[24].Trim() + "','" + IssueRowCount[25].Trim() + "','" + IssueRowCount[26].Trim() + "','" + IssueRowCount[27].Trim() + "','" + IssueRowCount[28].Trim() + "','" + IssueRowCount[29].Trim() + "','"
                //        //   + IssueRowCount[30].Trim() + "','" + IssueRowCount[31].Trim() + "','" + IssueRowCount[32].Trim() + "','" + IssueRowCount[33].Trim() + "','" + IssueRowCount[34].Trim() + "','" + IssueRowCount[35].Trim() + "','" + IssueRowCount[36].Trim() + "','" + IssueRowCount[37].Trim() + "','" + IssueRowCount[38].Trim() + "','" + IssueRowCount[39].Trim() + "','"
                //        //   + IssueRowCount[40].Trim() + "','" + IssueRowCount[41].Trim() + "','" + IssueRowCount[42].Trim() + "')", ConnectionZone);
            ...
            ////-----------------Deny-----------------------------
            //    String Deny = lines[8];
            //    string[] stringSeparatorsDeny = new string[] { "-###-" };
            //    var DenyCount = Deny.Split(stringSeparatorsDeny, StringSplitOptions.None);

            //    for (int i = 1; i <= DenyCount.Count() - 2; i++)
            //    {
            //        String DenyRow = DenyCount[i]; // lines[2];
            //        string[] stringSeparatorsDenyRow = new string[] { "\t" };

            //        var DenyRowCount = DenyRow.Split(stringSeparatorsDenyRow, StringSplitOptions.None);

            //        SqlConnection Connection = new SqlConnection();
            //        Connection.ConnectionString = ConfigurationManager.ConnectionStrings["connectionstring"].ConnectionString;

            //        string DPeople = "Delete From people where cerpac_file_no = (Select formno from Uploaded_Excel_Data_C where final_flag=2 and formno='" + DenyRowCount[0].Trim() + "')";
            //        string DPeopleChild = "Delete From PeopleChild where formno = (Select formno from Uploaded_Excel_Data_C where final_flag=2 and formno='" + DenyRowCount[0].Trim() + "')";
            //        string DCerpacNo_Out_One = "Delete From CerpacNo_Out_One where cerpac_file_no = (Select formno from Uploaded_Excel_Data_C where final_flag=2 and formno='" + DenyRowCount[0].Trim() + "')";
            //        string DUploaded_Excel_Data = "Delete From Uploaded_Excel_Data where formno = (Select formno from Uploaded_Excel_Data_C where final_flag=2 and formno='" + DenyRowCount[0].Trim() + "')";
            //        string DUploaded_Excel_Data_C = "Delete From Uploaded_Excel_Data_C where formno = (Select formno from Uploaded_Excel_Data_C where final_flag=2 and formno='" + DenyRowCount[0].Trim() + "')";
                    
            //        SqlCommand Command1 = new SqlCommand(DPeople, Connection);
            //        SqlCommand Command2 = new SqlCommand(DPeopleChild, Connection);
            //        SqlCommand Command3 = new SqlCommand(DCerpacNo_Out_One, Connection);
            //        SqlCommand Command4 = new SqlCommand(DUploaded_Excel_Data, Connection);
            //        SqlCommand Command5 = new SqlCommand(DUploaded_Excel_Data_C, Connection);
            //        Connection.Open();
                ...
                for (int i = 0; i <= result.Count() - 2; i++)
                {
                    ...
                    if (result[i].ToString().Substring(0, 2).Trim() == "AO" || result[i].ToString().Substring(0, 2).Trim() == "AR" || result[i].ToString().Substring(0, 2).Trim() == "CR" || result[i].ToString().Substring(0, 2).Trim() == "NG")
                    {
                        ...
                        if (dt.Rows[0].ItemArray[0].ToString() != "0")
                        {
                            ...
                            SqlCommand Command = new SqlCommand("Update uploaded_excel_data_C set Final_flag=1, resuserid='" + UserID.ToString().Trim() + "', response_date='" + datep(date.ToString()) + "' where formno ='" + result[i].ToString().Trim() + "'", Connection);
        ...
        try
        {
            ...
            for (int i = 0; i <= TotalReq.Count() - 2; i++)
            {
                ...
                if (TotalReq[i].ToString().Substring(0, 2).Trim() == "AO" || TotalReq[i].ToString().Substring(0, 2).Trim() == "AR" || TotalReq[i].ToString().Substring(0, 2).Trim() == "CR" || TotalReq[i].ToString().Substring(0, 2).Trim() == "NG")
                {
                    //-----------------Search in Upload excel data C table--------------------
                    ObjGenBal = new BaseLayer.General_function();
                    string QuerCountFound = "select count(*) from uploaded_excel_data_C where isnull( final_flag,0)<>1 and   Formno='" + TotalReq[i].ToString().Trim() + "' and zone_name='" + lblZonename.Text.Trim() + "'";
