<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Bank_UploadBankData, App_Web_uploadbankdata.aspx.fc41e3a" enableeventvalidation="false" %>
...
<div style="text-align:center;  display:block;" class="t11"  runat="server" id="main" >
           ...
           <tr>
                ...
                <td colspan="3" style="height: 5px">
                    <div class="PageNameHeadingCSS" style="width:749px; text-align: center;">
                        <font class="b12"><span style="font-size: 16px; color:White;">&nbsp;Upload Bank Data As Temporary&nbsp; </span>
                        </font>
                    </div>
                </td>
...
<b>
    ...
    <asp:Label ID="lbl_excel_file" runat="server" Text="Please Select Excel File: " Font-Size="Medium"></asp:Label>
</b>
...
<table>
 <tr><td align="center"><div class="confirmation-box"  style="width:168% !important; display:none;" id="confirm" runat="server"><p style="color:#006600"><strong>File Upload Sucessfully</strong></p></div></td></tr>
...
<asp:GridView ID="gvProducts" PageSize="20" AllowPaging="false" AutoGenerateColumns="false"  CellSpacing="1" CellPadding="7" GridLines="None"  EmptyDataText="No Data Avialable" OnPageIndexChanging="gvProducts_PageIndexChanging" runat="server" CssClass="GridBaseStyle" PagerStyle-CssClass="pgr" Style="font-size: 12px;">
...
--%>
    ...
    <asp:TemplateField headertext="PassportNo" Visible="false">
        <HeaderStyle HorizontalAlign="center" Width="200px" />
        <ItemStyle HorizontalAlign="left" Width="200px"/>
        <ItemTemplate>
    ...
    <asp:TemplateField headertext="MiddleName" Visible="false">
        <HeaderStyle HorizontalAlign="center" Width="200px" />
        <ItemStyle HorizontalAlign="left" Width="200px"/>
        <ItemTemplate>
    ...
    <asp:TemplateField headertext="CerpacNo" Visible="false">
        <HeaderStyle HorizontalAlign="center" Width="200px" />
        <ItemStyle HorizontalAlign="left" Width="200px"/>
        <ItemTemplate>
    ...
    <asp:TemplateField headertext="StrVisa No." Visible="false">
        <HeaderStyle HorizontalAlign="center" Width="200px" />
        <ItemStyle HorizontalAlign="left" Width="200px"/>
        <ItemTemplate>
    ...
    <asp:TemplateField headertext="Secured Sold Form No.">
...
<asp:Button ID="btnCopy" runat="server" Text="Upload As Temporary" OnClick="Copy" Enabled="true" Visible="true"  class="adminbutton" OnClientClick="ShowProgress();"/>

    <asp:Button ID="btnClean" runat="server" Text="Cancel" Visible="false"  class="adminbutton" OnClick="btnClean_Click"/>
<%--</ContentTemplate></asp:UpdatePanel>--%>
