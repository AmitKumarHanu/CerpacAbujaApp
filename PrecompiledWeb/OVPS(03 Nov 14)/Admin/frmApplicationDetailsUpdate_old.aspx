<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_frmApplicationDetailsUpdate, App_Web_frmapplicationdetailsupdate_old.aspx.fdf7a39c" %>
...
.warning-box {
    ...
    <div id="Div_ContentPlaceHolder" align="center" class="bcolour">
     ...
     <a href="../icao.pdf" target="_blank" class="tooltip" title=" Click to view ICAO Photo Recommendations.">
           <img src="../img/img.png" id="fimg" name="fimg" class="fimg" style=" height:164px; top: 277px; left: 699px; position:absolute; width:164px; border-radius: 6px; z-index: 9999; border: 2px solid #000;">
...
<tr class="b55"><td  class="b55" align="left">Middle Name</td><td align="left">
                        ...
                        <table cellpadding="5" cellspacing="2" border="0" width="745px" id="detailtable" runat="server">
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;" >
                                    <asp:TextBox ID="TxtPassportNo" runat="server" CssClass="textbox2" MaxLength="9" onblur="ValidatePassportNumber()" onkeyup="AllowAlphabetpp()" AutoComplete="Off"></asp:TextBox>
                                <span class="star">*                           
                            </span>
                                </td>
                                <td align="left" style="width: 150px;">
                            ...
                            <tr class="b55">
                                ...
                                <td align="left" style="width: 190px;" valign="bottom">
                                    ...
                                    <asp:TextBox ID="txtcompname" runat="server" CssClass="textbox2" AutoComplete="Off"></asp:TextBox> </a>
                                 <span class="star">*  
            ...
            <tr class="b11">
                ...
                <td align="left" style="height: 20px;">
                    <asp:Label ID="lbldeprel" runat="server" Text="Dependence Relation" Visible="false"></asp:Label></td>
                                 <td align="left"><asp:DropDownList ID="drprltn" runat="server" CssClass="textbox2" Visible="false"></asp:DropDownList></td>
...
<tr >
    ...
    <td align="left" colspan="3"><asp:TextBox Style="resize:none;" ID="txtnotes" runat ="server" Height="44px" AutoComplete="Off" Width="550px" MaxLength="100"></asp:TextBox></td>
            </tr>
                            <tr class="b11">
                <td colspan="4" align="left" style="height: 20px;">
                </td>
            ...
            <tr class="b11">
                <td align="center" colspan="4">
                    ...
                    <asp:Button ID="btnverify" runat="server" class="adminbutton" Text="Update Applicant History" onclick="btnverify_Click" OnClientClick="javascript:return buttonchange();" />&nbsp;&nbsp;&nbsp;&nbsp;
