<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_ProductionDetails, App_Web_productiondetails.aspx.fdf7a39c" %>
                            ...
                            <tr class="b11">
                                <td align="right" style="width: 10%; vertical-align: middle; text-align: center;">
                                  ...
                                  <div style="background-image: url('../Images/front1.png'); height: 350px; width: 564px; border: 1px solid black; background-repeat:no-repeat;" align="right">
                                      ...
                                      <asp:Image ID="ImgPhoto" runat="server" Style="position:absolute;top: 90px;left: 111px;height: 163px;width: 149px;" />
                                           </div>
