<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" enableeventvalidation="false" inherits="Admin_frmExceptionReport, App_Web_frmexceptionreport.aspx.fdf7a39c" %>
                              ...
                              <% 
                                ...
                                <td align="left" valign="middle"> 
                                    <%=Convert.ToString(i+1)%>
                                       ...
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["firstname"])).ToUpper()%>
                                </td>
                                      
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["lastname"])).ToUpper()%>
                                </td>
                                       <td align="left" valign="middle">
                                       ...
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["surname"])).ToUpper()%>
                                </td>
                                      
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["company_p"])).ToUpper()%>
                                </td>
                                 <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["designation"])).ToUpper()%>
                                </td>
                                       <td align="left" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["nationality_p"])).ToUpper()%>
                                </td>
