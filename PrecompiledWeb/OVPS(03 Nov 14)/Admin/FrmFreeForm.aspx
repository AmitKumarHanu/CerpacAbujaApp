<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_FrmFreeForm, App_Web_frmfreeform.aspx.fdf7a39c" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <link href="../css/country.css" rel=Stylesheet type="text/css" /> 
     <script type="text/javascript">
         function change() {
             if (document.getElementById('<%=txtssfn.ClientID %>').value != '') {
            ...
            <tr>
                <td colspan="3" style="height: 5px">
                    <div class="PageNameHeadingCSS" style="text-align: center">
                        <font class="b12"><span style="font-size: 16px; color:White;">&nbsp;Reverse Forms&nbsp; </span>
                        </font>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td align="center">
                    <table class="t11"  style="width: 100%;">
                        ...
                        <tr>
                            <td colspan="4" align="center"><asp:Button ID="Go" runat="server"  
                                    Text="Free this form" class="adminbutton" ValidationGroup="a"
                                     OnClientClick="return change()" onclick="Go_Click" />
                            </td>
