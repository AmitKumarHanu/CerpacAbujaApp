<%@ page language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_ApplicationProcess, App_Web_applicationprocess.aspx.fdf7a39c" title="Applicant Status Master" %>
                        ...
                        <tr>
                           <td colspan="4" align="center">
                               <asp:RadioButtonList runat="server" RepeatColumns="2" ID="radbrkcnt" OnSelectedIndexChanged="radbrkcnt_SelectedIndexChanged" AutoPostBack="true" Visible="false">
                                   <asp:ListItem Text="Break Case" Value="1"></asp:ListItem>
