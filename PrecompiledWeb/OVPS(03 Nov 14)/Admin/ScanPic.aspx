<%@ page language="C#" autoeventwireup="true" inherits="Admin_ScanPic, App_Web_scanpic.aspx.fdf7a39c" %>
...
<script language="javascript" type="text/javascript">
    ...
    function page_redirect() {
        ...
        window.navigate("http://192.168.1.11/Admin/ResultPage.aspx?fp=false&id=<%=lblid.Text%>");
    ...
    function scan_v19(id) {
        ...
        Object123.AcquireImageBWCropRotatePOST(
            "http://192.168.1.11/Admin/ResultPage.aspx?fp=true&id=id", //the page to receive the image 
    ...
    function scan_ghost(id) {
        //Object123.TwainSelectSource();
        Object123.AcquireImageCropPOST("http://192.168.1.11/Admin/ResultPage.aspx?fp=true&id=id", //the page to receive the image
            "c:\\region1.bmp", //local file name to save the image
            600, 600,   //scanning x and y resolutions
    ...
    function scan_pic(id) {
        //alert(id);
        Object123.AcquireImageCropPOST("http://192.168.1.11/Admin/scannedpic.aspx?fp=true&id=<%=lblid.Text%>", //the page to receive the image
            "c:\\scanpic.jpg", //local file name to save the image
            140, 140,   //scanning x and y resolutions
            0, //513, //x strart point coordinate
            0, //1255, //y start point coordinate
            200,   //width  1000
            250 //height
            );
        window.setTimeout(page_redirect_pic, 10000);
    }
    function page_redirect_pic() {
        //window.location.href = "http://localhost:1452/WebSite5/ResultPage.aspx";
        window.navigate("http://192.168.1.11/Admin/scannedpic.aspx?fp=false&id=<%=lblid.Text%>");
        //response.sendRedirect("http://localhost:1452/WebSite5/ResultPage.aspx");
    }
...
<!--.........................................................content start................................................-->
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
    ...
    <input type="button"  value="Select Source"  onclick="selectsource()" id="ScanBtn0" class="adminbutton"  style="position:absolute; top:251px; left:509px;"
        name="ScanBtn0" style="display:none" /><br />
   <br />
                 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <input type="button" value="Scan Photo" onclick="scan_pic('<%=lblid.Text%>')" id="ScanBtn"
