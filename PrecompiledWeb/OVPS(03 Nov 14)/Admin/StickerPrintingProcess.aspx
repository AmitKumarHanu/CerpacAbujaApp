<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_StickerPrintingProcess, App_Web_stickerprintingprocess.aspx.fdf7a39c" %>
...
<ContentTemplate>--%>
    ...
    <div style="background-image: url('../Images/sticker.png');height:623px; width:412px; margin-left: 164px;" id="div_grd" runat="server">
       ...
       <asp:Label ID="issued" Text="asdfasfdasdf" style="float:left;" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label>
            ...
            <asp:Label ID="address1" style="position:absolute; top:306px;" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label>
            <asp:Label ID="address2" style="position:absolute; top:340px;" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label>
        </span>
        <!--till here -->
