<%@ page language="C#" autoeventwireup="true" inherits="Admin_CompanyPopUp, App_Web_companypopup.aspx.fdf7a39c" enableeventvalidation="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function AllowAlphabet() {
            var desig = document.getElementById("<%=TextBoxName.ClientID%>").value;
...
<body>
    ...
    <table style=" width:200px; height:100px;" >
     ...
     <td align="center">
       <asp:TextBox ID="TextBoxName" runat="server" Width="171px" CssClass="txtbox" Height="26px" onkeyup="AllowAlphabet();" TabIndex="1"></asp:TextBox>
     </td> 
     <td align="left">
         <div class="Adminshortcuts" style="height:40px;">
       
    <asp:LinkButton ID="btn_search" runat="server" Text="Search" OnClick="btn_search_Click" CssClass="Adminshortcut" Width="40px" TabIndex="2">

       <center> <i class="shortcut-icon icon-search"></i></center>
