<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" enableeventvalidation="false" inherits="Admin_FrmConfirmListAO, App_Web_frmdenialformlist.aspx.fdf7a39c" %>
                    ...
                    <table class="auto-style1" >
                        <tr>
                            <td align="center" class="auto-style2">
                               <strong>FORM No </strong><span style="font-size:12px;"><strong ></strong></span> &nbsp;&nbsp;
                      ...
                      <tr><td height=20px></td></tr>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Form No." Visible="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblformno" runat="server" Text='<%# Bind("Cerpac_file_no") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                            </asp:TemplateField>
