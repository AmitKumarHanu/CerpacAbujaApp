<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_FrmWrongformsused, App_Web_frmwrongformsused.aspx.fdf7a39c" %>
     ...
     <div id="R1" align="center" style="overflow: scroll; height:auto;"  runat="server" >
           ...
           <div id="DivReport" style="width: 800px;">
                        ...
                        <table style="width:100%;" align="center">
                            <tr>
                                <td>&nbsp;</td>
                                <td align="center" colspan="4" >Datewise Wrong Forms Used Report</td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                       ...
                       <%
                        ...
                        <table class="GridBaseStyle"   border="1" cellspacing="1"  rules="all" style="width: 90%; height:200px; overflow: scroll; clip: rect(auto, auto, auto, auto);">
                            ...
                            <tr class="Grid_Header">
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle" colspan="5">Bank Data</th>
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle" colspan="6">Data Entered</th>
                            ...
                            <tr class="Grid_Header">
                                ...
                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Rejected By</th>
                                ...
                                <td align="center" valign="middle"> 
                                    <%=Convert.ToString(i+1)%>
                                      ...
                                      <td align="center" valign="middle">
                                       ...
                                       <td align="center" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["fname"])).ToUpper()%>
                                </td>
                                      
                                       <td align="center" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["lname"])).ToUpper()%>
                                </td>
                                       ...
                                       <td align="center" valign="middle">
                                        ...
                                        <td align="center" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["VerifiedBy"])).ToUpper()%>
                                </td>
                                                                           
                                       <td align="center" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["AuthorizedBy"])).ToUpper()%>
                                </td>
                                       <td align="center" valign="middle">
                                         <%=(Convert.ToString(objDs.Tables[0].Rows[i]["ConfirmedBy"])).ToUpper()%>
                                </td>
                                       <td align="center" valign="middle">
                                         <%=(Convert.ToString(dpd_zone.SelectedItem).ToUpper())%>
                                </td>
