<%@ page language="C#" masterpagefile="~/MasterPage/MasterPageUser.master" autoeventwireup="true" inherits="Admin_FrmVisaIssue, App_Web_frmvisaissuelist.aspx.fdf7a39c" title="Visa issue List" %>
...
<table cellpadding="2" cellspacing="10" style="border:1px solid #dddddd; width:95%">
    <tr>
        <td colspan="2" class="PageNameHeadingCSS_2" align="center"> Visa issue List
        </td>
    </tr>
        ...
        <td valign="top" align="center" style="width: 100%; height:150px text-align: left;">
	       ...
	       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
               ...
               <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" 
                    ...
                    <asp:BoundField DataField="Approver3Status" HeaderText="Final Status">
                        <HeaderStyle HorizontalAlign="Left" Width="13%" />
                        <ItemStyle HorizontalAlign="Left" Width="13%" />
                    </asp:BoundField>
