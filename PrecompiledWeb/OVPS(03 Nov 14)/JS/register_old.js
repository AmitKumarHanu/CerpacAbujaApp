...
function openLastLived() {
    ...
    //immegration
     ...
     function DisplayPrevApplied() {
        var objpnl = document.getElementById('trPrevApplied');
        objpnl.style.display = '';
    }
   ...
   function DisplayPrevVisit() {
        var objpnl = document.getElementById('trVisit');
        objpnl.style.display = '';
    }
    ...
    function HideVisaGranted() {
     ...
     function DisplayRefusedAnyCountry() {
        var objpnl = document.getElementById('trRefusedAnyCountry');
        objpnl.style.display = '';
    }
   ...
   function DisplayRefusedOnArrival() {
    ...
    function DisplayConvictionInOtherCountry() {
        var objpnl = document.getElementById('trConvictionInOtherCountry');
        objpnl.style.display = '';
    }
...
//travell details
    ...
    function DisplayDisease() {
        var objpnl = document.getElementById('trDisease');
        objpnl.style.display = '';
    }
    ...
    function DisplayDrugReport() {
        var objpnl = document.getElementById('trDrugReport');
        objpnl.style.display = '';
    }
    ...
    function DisplayFraudRecord() {
        var objpnl = document.getElementById('trFraudRecord');
        objpnl.style.display = '';
    }
    ...
    function HideFraudRecord() {
     ...
     function DisplayOtherNationality() {
        var objpnl = document.getElementById('trOtherNationality');
        objpnl.style.display = '';
    }
    ...
    function HideOtherNationality() {
     ...
     function DisplayDeportedOtherCountry() {
        var objpnl = document.getElementById('trDeportedOtherCountry');
        objpnl.style.display = '';
    }
