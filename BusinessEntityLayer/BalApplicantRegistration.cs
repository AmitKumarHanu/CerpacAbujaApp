...
namespace BusinessEntityLayer
{
    public class BalApplicantRegistration
    {
       ...
       // public byte[] bphoto { get; set; }
        ...
        public string docofincorporation { get; set; }

        public int CompanyRegistration()
        {
            DataAccessLayer.DalApplicantRegist ObjDalApplicantRegist = null;
            DataTable dt = null;
            //try
            ...
            dt.Columns.Add("docofincorporation");
            ...
            dr["Directorname"] = this.Directorname;
            dr["Address"] = this.Address;
            dr["Phoneno"] = this.Phoneno;
            dr["Contactperson"] = this.Contactperson;
            dr["DateofIncorporation"] = this.DateofIncorporation;
            dr["Designation"] = this.Designation;
            dr["MobileNo"] = this.MobileNo;
            dr["UniqueCode"] = this.UniqueCode;
            dr["userid"] = this.userid;
            dr["docofincorporation"] = this.docofincorporation;

            dt.Rows.Add(dr);
            return ObjDalApplicantRegist.CompanyRegistration(dt);
